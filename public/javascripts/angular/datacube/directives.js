        ...
        .directive('czRegionMap', [function () {
            ...
            function link(scope, element, attr) {
                ...
                function regionOut(object) {
                    ng.element(object).attr("stroke", "none");
                    ng.element(object).attr("stroke-width", "0px");
                    scope.ttShow = "none";
                    scope.$apply();
                }
                ...
                function regionOver(object, e) {
                    ng.element(object).attr("stroke", "red");
                    ng.element(object).attr("stroke-width", "5px");
                    ...
                    setTooltip(dataTitle, getRegionName(ng.element(object).attr("region")),
                        ng.element(object).attr("name"), ng.element(object).attr("title"));
                }
                    ...
                    try {
                        ...
                        for (i = 0; i < el.length; i++) {
                            ...
                            if (el[i].getAttribute("region") == id) {
                                ...
                                ng.element(el[i]).attr("fill", color);
                                ng.element(el[i]).attr("name", value);
                                ng.element(el[i]).attr("title", value2);
                            }
                        }
                    } catch (e) {
