...
import controllers.assistant.api.visualizers.{ChordVisualizerApiController, CommonVisualizerApiController, MapsVisualizerApiController, EventVisualizerApiController}
...
class ControllerModule extends Module {
  ...
  binding to new EventVisualizerApiController
