 ...
 *
 * Note: This is part of Play Framework 2.4. We had to manually take it and put it here to get
 * the Result serialization working.
 */
final class SerializableResult(constructorResult: Result) extends Externalizable {
