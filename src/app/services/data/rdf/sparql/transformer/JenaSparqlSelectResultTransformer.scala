...
import services.data.rdf.sparql.model.{SparqlResultSolution, SparqlResultSet}
import services.data.rdf.vocabulary.SPARQL
import scala.collection.JavaConversions._

class JenaSparqlSelectResultTransformer extends SparqlResultTransformer[JenaLangTtl, Seq[SparqlResultSet]] {
