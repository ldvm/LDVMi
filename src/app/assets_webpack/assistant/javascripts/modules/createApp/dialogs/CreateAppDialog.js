...
const CreateAppDialog = (props) =>  {
  ...
  const actions = [
    ...
    <Button label="Create view" success raised disabled={submitting} icon="create"
      onTouchTap={handleSubmit} />
  ];

  return (
    <Dialog name={dialogName} title="Create view" actions={actions}>
      <p>Choose name for your new view (it can be changed later). The view will
