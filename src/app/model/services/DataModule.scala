...
class DataModule extends Module {
  ...
  bind[VisualizerCompatibilityService] to new VisualizerCompatibilityServiceImpl
  bind[VisualizerFeatureCompatibilityService] to new VisualizerFeatureCompatibilityServiceImpl
