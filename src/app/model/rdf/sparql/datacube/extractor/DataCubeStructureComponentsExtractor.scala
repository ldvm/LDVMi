...
import model.rdf.sparql.datacube.query.DataCubeStructureComponentsQuery
...
class DataCubeStructureComponentsExtractor extends QueryExecutionResultExtractor[DataCubeStructureComponentsQuery, Seq[DataCubeComponent]] {
