...
create table "VISUALIZATIONS" ("ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"NAME" VARCHAR NOT NULL,"DATASOURCE_ID" BIGINT NOT NULL,"DSD_DATASOURCE_ID" BIGINT NOT NULL);
