...
create table "assistant_cache_entries" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"key" VARCHAR NOT NULL,"value" VARCHAR NOT NULL);
create unique index "idx_unique_key" on "assistant_cache_entries" ("key");
create table "assistant_user_datasources" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"isPublic" BOOLEAN NOT NULL,"user_id" BIGINT NOT NULL,"datasource_template_id" BIGINT NOT NULL);
create table "assistant_user_pipeline_discovery" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"user_id" BIGINT NOT NULL,"pipeline_discovery_id" BIGINT NOT NULL);
create table "assistant_users" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"email" VARCHAR NOT NULL,"password" VARCHAR NOT NULL,"isAdmin" BOOLEAN DEFAULT false NOT NULL);
create unique index "idx_unique_email" on "assistant_users" ("email");
create table "assistant_views" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"uid" VARCHAR NOT NULL,"description" VARCHAR,"published" BOOLEAN DEFAULT false NOT NULL,"user_id" BIGINT NOT NULL,"pipeline_id" BIGINT NOT NULL,"user_pipeline_discovery_id" BIGINT NOT NULL,"visualizer_component_template_id" BIGINT NOT NULL,"configuration" VARCHAR);
...
create table "pipeline_evaluation_queries" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"evaluation_id" BIGINT NOT NULL,"token" VARCHAR NOT NULL,"data" VARCHAR NOT NULL,"uuid" VARCHAR NOT NULL,"created" TIMESTAMP,"modified" TIMESTAMP);
...
create table "pipelines" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"binding_set_id" BIGINT NOT NULL,"uri" VARCHAR NOT NULL,"title" VARCHAR NOT NULL,"description" VARCHAR,"visualizer_component_template_id" BIGINT NOT NULL,"is_temporary" BOOLEAN NOT NULL,"pipeline_discovery_id" BIGINT,"uuid" VARCHAR NOT NULL,"created" TIMESTAMP,"modified" TIMESTAMP);
...
create table "visualization_configuration" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"visualizer_uri" VARCHAR NOT NULL,"visualization_uri" VARCHAR NOT NULL,"visualization_priority" INTEGER NOT NULL,"assistant_name" VARCHAR NOT NULL,"assistant_icon" VARCHAR NOT NULL,"assistant_disabled" BOOLEAN DEFAULT false NOT NULL,"uuid" VARCHAR NOT NULL,"created" TIMESTAMP,"modified" TIMESTAMP);
create unique index "idx_unique_visualizer_uri" on "visualization_configuration" ("visualizer_uri");
...
alter table "analyzer_templates" add constraint "fks_at_ctt_component_template_id" foreign key("component_template_id") references "component_templates"("id") on update NO ACTION on delete NO ACTION;
...
alter table "pipeline_evaluation_queries" add constraint "fk_vqt_pet_evaluation_id" foreign key("evaluation_id") references "pipeline_evaluation"("id") on update NO ACTION on delete NO ACTION;
...
alter table "pipelines" add constraint "visualizer_component_template" foreign key("visualizer_component_template_id") references "component_templates"("id") on update NO ACTION on delete NO ACTION;
...
alter table "pipelines" drop constraint "visualizer_component_template";
...
alter table "pipeline_evaluation_queries" drop constraint "fk_vqt_pet_evaluation_id";
...
alter table "analyzer_templates" drop constraint "fks_at_ctt_component_template_id";
...
drop table "assistant_views";
drop table "assistant_users";
drop table "assistant_user_pipeline_discovery";
drop table "assistant_user_datasources";
drop table "assistant_cache_entries";
