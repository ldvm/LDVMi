...
create table "VISUALIZATION_QUERIES" ("ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"VISUALIZATION_ID" BIGINT NOT NULL,"DATA" VARCHAR NOT NULL);
