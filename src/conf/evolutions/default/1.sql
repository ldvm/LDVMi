...
create table "analyzer_templates" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"component_template_id" BIGINT NOT NULL,"created" TIMESTAMP,"modified" TIMESTAMP);
create table "component_instance_compatibility_checks" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"component_instance_id" BIGINT NOT NULL,"data_port_binding_set_id" BIGINT NOT NULL,"is_finished" BOOLEAN NOT NULL,"is_success" BOOLEAN,"created" TIMESTAMP,"modified" TIMESTAMP);
...
create table "component_templates" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"uri" VARCHAR NOT NULL,"title" VARCHAR NOT NULL,"description" VARCHAR,"default_configuration" VARCHAR,"created" TIMESTAMP,"modified" TIMESTAMP);
create table "data_port_binding_set_compatibility_checks" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"data_port_binding_set_id" BIGINT NOT NULL,"is_finished" BOOLEAN NOT NULL,"is_success" BOOLEAN,"created" TIMESTAMP,"modified" TIMESTAMP);
...
create table "dataport_templates" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"uri" VARCHAR NOT NULL,"title" VARCHAR NOT NULL,"description" VARCHAR,"component_template_id" BIGINT NOT NULL,"created" TIMESTAMP,"modified" TIMESTAMP);
...
create table "datasource_templates" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"component_template_id" BIGINT NOT NULL,"created" TIMESTAMP,"modified" TIMESTAMP);
create table "descriptor_compatibility_checks" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"descriptor_id" BIGINT NOT NULL,"feature_id" BIGINT NOT NULL,"component_instance_id" BIGINT NOT NULL,"data_port_binding_set_id" BIGINT NOT NULL,"is_finished" BOOLEAN NOT NULL,"is_success" BOOLEAN,"created" TIMESTAMP,"modified" TIMESTAMP);
create table "descriptors" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"feature_id" BIGINT NOT NULL,"input_template_id" BIGINT NOT NULL,"query" VARCHAR NOT NULL,"title" VARCHAR NOT NULL,"description" VARCHAR,"created" TIMESTAMP,"modified" TIMESTAMP);
create table "feature_compatibility_checks" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"feature_id" BIGINT NOT NULL,"component_instance_id" BIGINT NOT NULL,"data_port_binding_set_id" BIGINT NOT NULL,"is_finished" BOOLEAN NOT NULL,"is_success" BOOLEAN,"created" TIMESTAMP,"modified" TIMESTAMP);
...
create table "input_templates" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"dataport_template_id" BIGINT NOT NULL,"component_id" BIGINT NOT NULL,"created" TIMESTAMP,"modified" TIMESTAMP);
...
create table "output_templates" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"output_data_sample" VARCHAR,"dataport_template_id" BIGINT NOT NULL,"component_template_id" BIGINT NOT NULL,"created" TIMESTAMP,"modified" TIMESTAMP);
create table "pipeline_discovery" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"is_finished" BOOLEAN NOT NULL,"is_success" BOOLEAN,"last_performed_iteration" INTEGER,"pipelines_discovered_count" INTEGER,"created" TIMESTAMP,"modified" TIMESTAMP);
create table "pipelines" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"binding_set_id" BIGINT NOT NULL,"uri" VARCHAR NOT NULL,"title" VARCHAR NOT NULL,"description" VARCHAR,"is_temporary" BOOLEAN NOT NULL,"pipeline_discovery_id" BIGINT,"created" TIMESTAMP,"modified" TIMESTAMP);
...
create table "transformer_templates" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"component_template_id" BIGINT NOT NULL,"created" TIMESTAMP,"modified" TIMESTAMP);
...
create table "visualizer_templates" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"component_id" BIGINT NOT NULL,"created" TIMESTAMP,"modified" TIMESTAMP);
