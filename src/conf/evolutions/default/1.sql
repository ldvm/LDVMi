...
create table "appgen_applications" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"uid" VARCHAR NOT NULL,"description" VARCHAR,"user_id" BIGINT NOT NULL,"pipeline_id" BIGINT NOT NULL,"user_pipeline_discovery_id" BIGINT NOT NULL);
