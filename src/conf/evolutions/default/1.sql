...
create table "USERS" ("ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"NAME" VARCHAR NOT NULL,"EMAIL" VARCHAR NOT NULL,"PASSWORD" VARCHAR NOT NULL);
