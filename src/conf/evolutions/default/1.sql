...
create table "component_templates" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"uri" VARCHAR NOT NULL,"title" VARCHAR NOT NULL,"description" VARCHAR,"" BIGINT,"default_configuration" VARCHAR,"uuid" VARCHAR NOT NULL,"created" TIMESTAMP,"modified" TIMESTAMP);
...
create table "dataport_bindings" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"binding_set_id" BIGINT NOT NULL,"source_port_id" BIGINT NOT NULL,"target_data_port_id" BIGINT NOT NULL,"uuid" VARCHAR NOT NULL,"created" TIMESTAMP,"modified" TIMESTAMP);
...
alter table "dataport_bindings" add constraint "fk_dpbt_dpt_source_port_id" foreign key("source_port_id") references "dataport_instances"("id") on update NO ACTION on delete NO ACTION;
