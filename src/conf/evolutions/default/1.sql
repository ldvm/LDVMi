...
create table "appgen_applications" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"uid" VARCHAR NOT NULL,"description" VARCHAR,"published" BOOLEAN DEFAULT false NOT NULL,"user_id" BIGINT NOT NULL,"pipeline_id" BIGINT NOT NULL,"user_pipeline_discovery_id" BIGINT NOT NULL,"visualizer_component_template_id" BIGINT NOT NULL,"configuration" VARCHAR);
create table "appgen_cache_entries" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"key" VARCHAR NOT NULL,"value" VARCHAR NOT NULL);
create unique index "idx_unique_key" on "appgen_cache_entries" ("key");
create table "appgen_user_datasources" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"isPublic" BOOLEAN NOT NULL,"user_id" BIGINT NOT NULL,"datasource_template_id" BIGINT NOT NULL);
create table "appgen_user_pipeline_discovery" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"user_id" BIGINT NOT NULL,"pipeline_discovery_id" BIGINT NOT NULL);
create table "appgen_users" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"email" VARCHAR NOT NULL,"password" VARCHAR NOT NULL,"isAdmin" BOOLEAN DEFAULT false NOT NULL);
create unique index "idx_unique_email" on "appgen_users" ("email");
...
create table "visualization_configuration" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"visualizer_uri" VARCHAR NOT NULL,"visualization_uri" VARCHAR NOT NULL,"visualization_priority" INTEGER NOT NULL,"appgen_name" VARCHAR NOT NULL,"appgen_icon" VARCHAR NOT NULL,"appgen_disabled" BOOLEAN DEFAULT false NOT NULL,"uuid" VARCHAR NOT NULL,"created" TIMESTAMP,"modified" TIMESTAMP);
...
drop table "appgen_users";
drop table "appgen_user_pipeline_discovery";
drop table "appgen_user_datasources";
drop table "appgen_cache_entries";
drop table "appgen_applications";
