...
alter table "analyzer_instances" add constraint "fk_ait_ats_analyzer_id" foreign key("analyzer_id") references "analyzer_templates"("id") on update NO ACTION on delete NO ACTION;
...
alter table "analyzer_instances" drop constraint "fk_ait_ats_analyzer_id";
